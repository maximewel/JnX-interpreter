...
_lr_productions = [
  ...
  ('balise_autoclose -> tag / >','balise_autoclose',3,'p_auto_balise','parserast.py',55),
  ('balise_autoclose -> tag attributes / >','balise_autoclose',4,'p_auto_balise','parserast.py',56),
  ('balise_autoclose -> tag_jnx / >','balise_autoclose',3,'p_auto_balise_jnx','parserast.py',63),
  ('balise_autoclose -> tag_jnx attributes / >','balise_autoclose',4,'p_auto_balise_jnx','parserast.py',64),
  ('balise_start -> tag >','balise_start',2,'p_balise_start','parserast.py',71),
  ('balise_start -> tag attributes >','balise_start',3,'p_balise_start','parserast.py',72),
  ('balise_start -> tag_jnx >','balise_start',2,'p_balise_start_jnx','parserast.py',79),
  ('balise_start -> tag_jnx attributes >','balise_start',3,'p_balise_start_jnx','parserast.py',80),
  ...
  ('attributes -> attribute','attributes',1,'p_attributes_sequence','parserast.py',122),
  ('attributes -> attributes attribute','attributes',2,'p_attributes_sequence','parserast.py',123),
  ('attribute -> token = ATTRIB_VAL','attribute',3,'p_attribute','parserast.py',130),
  ('token -> IDENTIFIER','token',1,'p_token','parserast.py',137),
  ('token_sequence -> token','token_sequence',1,'p_token_sequence','parserast.py',141),
  ('token_sequence -> token_sequence token','token_sequence',2,'p_token_sequence','parserast.py',142),
]
